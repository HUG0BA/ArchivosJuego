 ...
 */
public class ScoreArea extends Actor
{
    

    private String scoreKey = "A"; //Nombre de la tecla que se debe presionar 
    private DancingFloor dancingFloor; //Nombre del mundo utilizando para obtener acceso a contador
    ...
    public void AddPoints(int amount){
        dancingFloor = (DancingFloor) getWorld();
        Counter counter = dancingFloor.getCounter();
